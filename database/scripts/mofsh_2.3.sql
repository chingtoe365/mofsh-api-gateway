...
CREATE TABLE public.mofsh_ai_services (
    ...
    auth_in_header boolean DEFAULT true
);
...
--
-- Name: mofsh_bridge_service_cloud; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.mofsh_bridge_service_cloud (
    id integer NOT NULL,
    id_cloud_service integer,
    id_service integer
);


ALTER TABLE public.mofsh_bridge_service_cloud OWNER TO postgres;

--
-- Name: mofsh_bridge_service_cloud_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.mofsh_bridge_service_cloud_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.mofsh_bridge_service_cloud_id_seq OWNER TO postgres;

--
-- Name: mofsh_bridge_service_cloud_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.mofsh_bridge_service_cloud_id_seq OWNED BY public.mofsh_bridge_service_cloud.id;
...
--
-- Name: mofsh_cloud_services; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.mofsh_cloud_services (
    id integer NOT NULL,
    cloud_service text
);


ALTER TABLE public.mofsh_cloud_services OWNER TO postgres;

--
-- Name: mofsh_cloud_services_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.mofsh_cloud_services_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.mofsh_cloud_services_id_seq OWNER TO postgres;

--
-- Name: mofsh_cloud_services_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.mofsh_cloud_services_id_seq OWNED BY public.mofsh_cloud_services.id;
...
CREATE TABLE public.mofsh_fact_ai_services_arguments (
    ...
    ai_service_argument_content bytea
);
...
--
-- Name: mofsh_bridge_service_cloud id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mofsh_bridge_service_cloud ALTER COLUMN id SET DEFAULT nextval('public.mofsh_bridge_service_cloud_id_seq'::regclass);
...
--
-- Name: mofsh_cloud_services id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mofsh_cloud_services ALTER COLUMN id SET DEFAULT nextval('public.mofsh_cloud_services_id_seq'::regclass);
...
COPY public.mofsh_ai_services (id, ai_service_name, ai_service_description, endpoint, request_method, port, api_key, auth_in_header) FROM stdin;
13	cleverclog	AI telling dog brand	https://service.cleverclogs.com/tellDogBrand/	GET	5000	\N	f
18	cleverclog-catteller	AI telling cat brand	https://service.cleverclogs.com/tellCatBrand/	GET	5000	\N	f
15	Contrain-clause-topic-claissifer	Legal clause topic classifier	http://localhost:5000/api/v1/taxonomiser	POST	5000	\N	f
23	contrai_hello_world	Contrai hello world	http://localhost:5000	GET	5000	\N	f
29	doctor-prescription-parser	doctor prescription parser	localhost:4999	POST	4999	\N	f
26	contrai_foo_bar	Contrai Foo Bar	http://localhost:5000/api/v1/test	POST	5000	\N	t
\.
...
--
-- Data for Name: mofsh_bridge_service_cloud; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.mofsh_bridge_service_cloud (id, id_cloud_service, id_service) FROM stdin;
\.
...
--
-- Data for Name: mofsh_cloud_services; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.mofsh_cloud_services (id, cloud_service) FROM stdin;
\.
...
COPY public.mofsh_fact_ai_services_arguments (id, id_ai_service, id_argument, id_argument_type, ai_service_argument_content) FROM stdin;
14	13	4	1	\N
16	15	1	1	\N
19	18	11	1	\N
21	18	20	4	\N
...
1	26	1	f3d6b9c3-a497-4ebf-828b-928725ae1786
\.
...
COPY public.mofsh_users (username, email, organization, uuid, password, role) FROM stdin;
boston_legal	admin@bostonlegal.com	Boston Legal	88adf8a0-17ca-401f-a0ad-1875db6e3f77	\N	client
contrai_technology	admin@contraitechnologies.com	Contrai Technology	c105fda2-32e1-4046-bb25-cd71cb74e649	\N	client
jintao	jintaolong@brookes.ac.uk	Ethical AI Institute, Oxford Brookes University	517fcba2-e0e5-454f-af3b-22aac9e2699d	\N	client
jlinja	jlong@brookes.ac.uk	OBU	8cd29479-a84c-47a4-8226-cf07f8bfed32	{bcrypt}$2a$10$cKSl3nZ7x90UpEQn9uHA6upqTURYROxBw1jNtsPW8knIg3nypHF2m	client
whatever	braon@random.com	OOBU	70740c96-20ff-4cf8-81fa-c16db66fe496	{bcrypt}$2a$10$g01deJtykBaMVosVG.LB8.lNlu5d2wOA45LADV5yQSTMr69es.BeW	client
p0098	p0099334@brookes.ac.uk	OBU	f2621fec-130b-46dc-8222-9120c0f58d36	{bcrypt}$2a$10$NOZe7dOB.vB0yKPzITXqreNmjq61kK2Ow/PiwE5FCAqlKNF8AyBhG	client
testuser	j@gmail.com	OBU	f3d6b9c3-a497-4ebf-828b-928725ae1786	{bcrypt}$2a$10$/5RIiFfKG1YpepVdLqHDoO/Gsuv18jujd.qrau2p/ipcNkOvKh3FW	client
\.
...
SELECT pg_catalog.setval('public.mofsh_argument_types_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.mofsh_arguments_id_seq', 7, true);


--
-- Name: mofsh_bridge_service_cloud_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.mofsh_bridge_service_cloud_id_seq', 1, false);
...
--
-- Name: mofsh_cloud_services_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.mofsh_cloud_services_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.mofsh_fact_ai_services_arguments_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.mofsh_fact_services_users_id_seq', 1, true);
...
--
-- Name: mofsh_bridge_service_cloud mofsh_bridge_service_cloud_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mofsh_bridge_service_cloud
    ADD CONSTRAINT mofsh_bridge_service_cloud_pkey PRIMARY KEY (id);
...
--
-- Name: mofsh_cloud_services mofsh_cloud_services_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mofsh_cloud_services
    ADD CONSTRAINT mofsh_cloud_services_pkey PRIMARY KEY (id);
...
--
-- Name: mofsh_bridge_service_cloud mofsh_bridge_service_cloud_id_cloud_service_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mofsh_bridge_service_cloud
    ADD CONSTRAINT mofsh_bridge_service_cloud_id_cloud_service_fkey FOREIGN KEY (id_cloud_service) REFERENCES public.mofsh_cloud_services(id);


--
-- Name: mofsh_bridge_service_cloud mofsh_bridge_service_cloud_id_service_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mofsh_bridge_service_cloud
    ADD CONSTRAINT mofsh_bridge_service_cloud_id_service_fkey FOREIGN KEY (id_service) REFERENCES public.mofsh_ai_services(id);
...
ALTER TABLE ONLY public.mofsh_fact_services_users
    ADD CONSTRAINT mofsh_fact_services_users_uuid_user_fkey FOREIGN KEY (uuid_user) REFERENCES public.mofsh_users(uuid);
